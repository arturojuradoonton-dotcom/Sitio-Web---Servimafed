...
export default function WhatsAppButton() {
  ...
  return (
    <div
      ...
      className={`fixed bottom-6 right-6 z-[90] transition-all duration-700 ease-out ${
        isVisible ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-12 opacity-0 scale-75'
      }`}
    >
      {/* Tooltip */}
      <div
        className={`absolute bottom-full right-0 mb-3 whitespace-nowrap transition-all duration-300 pointer-events-none ${
      ...
      <a
        ...
        className="relative flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-[0_6px_24px_rgba(37,211,102,0.45)] hover:shadow-[0_8px_32px_rgba(37,211,102,0.6)] hover:scale-110 active:scale-95 transition-all duration-300"
      >
        <svg
          viewBox="0 0 32 32"
          fill="white"
